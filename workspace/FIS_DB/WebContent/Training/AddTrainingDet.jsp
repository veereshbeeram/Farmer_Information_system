...
<p><font face="Estrangelo Edessa" style="font-size: 20pt">Add Training Schedule With Details</font></p>
<a href="offView.action">Back</a>&nbsp;&nbsp;
		<a href="logout.action">Logout</a>	<br><br>
<form method="POST" action="addTrainingDet.action">
	<div class="message"><s:actionmessage />
	<s:actionerror /></div>
	<fieldset style="height: auto;">
	<legend align="left">Enter Details</legend> 	
	<p>Name&nbsp;&nbsp;&nbsp; <input type="text" name="training.name" size="20"><p>Description&nbsp;&nbsp;&nbsp; 
	<textarea rows="2" name="training.description" cols="20"></textarea>
	<div class="message"><s:fielderror> <s:param>training.name</s:param> </s:fielderror></div>	
	<p>Date&amp;Time&nbsp;&nbsp;&nbsp;&nbsp; 
	<input type="text" name="training.time"  size="20"/> 
	( dd/mm/yy&nbsp;hh:mm)</p>
	<div class="message"><s:fielderror> <s:param>training.time</s:param> </s:fielderror></div>
	<p>Duration&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="text" name="training.duration" size="7" /> days</p>
	<div class="message"><s:fielderror> <s:param>training.duration</s:param> </s:fielderror></div>	
	<p>Address&nbsp;&nbsp;&nbsp; 
	<textarea rows="2" name="training.address" cols="20"></textarea></p>
	<div class="message"><s:fielderror> <s:param>training.address</s:param> </s:fielderror></div>
	<p>Max no. of Registrations&nbsp;&nbsp;&nbsp; 
	<input type="text" name="training.maxCount" size="7"/></p>
